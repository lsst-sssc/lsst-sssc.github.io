...
for i in range(1, len(data)):
    ...
    #name
    html[41] = '                            '+html[41].replace("The member's name.", name)
    #affill
    html[42] = html[42].replace("The member's affiliation.", affil)[4:]
    #contact
    #html[43] = html[43].replace("Email address.", email)[4:]
    #summary
    html[43] = html[43].replace("A short 3-4 sentence description of the member's science interests.", sciInterests)[4:]
